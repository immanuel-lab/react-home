...
<center>
       ...
       <input type="number" placeholder="enter value..." ref={value}    onKeyPress={(e)=>setKey(e.key==='Enter')}     onChange={(e)=>setVal(e.target.value)} className="border border-pink-700"/>
        <button className="bg-green-500 p-1 text-bold text-white
